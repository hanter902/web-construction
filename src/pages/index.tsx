        ...
        <>
            <MasterLayout>
                ...
                <div className="container-fluid p-0 pb-5">
                    <OwlCarousel2 className="header-carousel owl-loaded owl-drag"  {...optionsHeader} >
                                ...
                                <div className="container">
                                    <div className="row justify-content-center">
                                        <div className="col-12 col-lg-8 text-center">
                                            <h5 className="text-white text-uppercase mb-3 animated animate__slideInDown">Welcome To WooDY</h5>
                                            <h1 className="display-3 text-white animated animate__slideInDown mb-4">Best Carpenter & Craftsman Services</h1>
                                            ...
                                            <a href="" className="btn btn-primary py-md-3 px-md-5 me-3 animated animate__slideInLeft">Read More</a>
                                            <a href="" className="btn btn-light py-md-3 px-md-5 animated animate__slideInRight">Free Quote</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="owl-carousel-item position-relative">
                            ...
                            <div className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style={{ background: 'rgba(53, 53, 53, .7)' }}>
                                <div className="container">
                                    <div className="row justify-content-center">
                                        <div className="col-12 col-lg-8 text-center">
                                            <h5 className="text-white text-uppercase mb-3 animated animate__slideInLeft">Welcome To WooDY</h5>
                                            <h1 className="display-3 text-white animated animate__slideInLeft mb-4">Best Carpenter & Craftsman Services</h1>
                                            <p className="fs-5 fw-medium text-white mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea elitr.</p>
                                            <a href="" className="btn btn-primary py-md-3 px-md-5 me-3 animated animate__slideInLeft">Read More</a>
                                            <a href="" className="btn btn-light py-md-3 px-md-5 animated animate__slideInLeft">Free Quote</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container-xxl py-5">
                    <div className="container">
                        <div className="row g-5">
                            <div className="col-md-6 col-lg-3 wow animate__animated animate__fadeIn animate__delay-0-1" data-wow-delay="0.1s">
                            ...
                            <div className="col-md-6 col-lg-3 wow animate__animated animate__fadeIn animate__delay-0-3" data-wow-delay="0.3s">
                                <div className="d-flex align-items-center justify-content-between mb-2">
                                    <div className="d-flex align-items-center justify-content-center bg-light" style={{ width: '60px', height: '60px' }}>
                            ...
                            <div className="col-md-6 col-lg-3 wow animate__animated animate__fadeIn animate__delay-0-5" data-wow-delay="0.5s">
                                <div className="d-flex align-items-center justify-content-between mb-2">
                                    <div className="d-flex align-items-center justify-content-center bg-light" style={{ width: '60px', height: '60px' }}>
                            ...
                            <div className="col-md-6 col-lg-3 wow animate__animated animate__fadeIn animate__delay-0-7" data-wow-delay="0.7s">
                                <div className="d-flex align-items-center justify-content-between mb-2">
                                    <div className="d-flex align-items-center justify-content-center bg-light" style={{ width: '60px', height: '60px' }}>
                ...
                <div className="container-fluid bg-light overflow-hidden my-5 px-lg-0">
                    <div className="container about px-lg-0">
                        <div className="row g-0 mx-lg-0">
                            ...
                            <div className="col-lg-6 about-text py-5 wow animate__animated animate__fadeIn animate__delay-0-5" data-wow-delay="0.5s">
                                <div className="p-lg-5 pe-lg-0">
                                    ...
                                    <div className="row g-4 mb-4 pb-2">
                                        <div className="col-sm-6 wow animate__animated animate__fadeIn animate__delay-0-1" data-wow-delay="0.1s">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="ms-3">
                                                    <h2 className="text-primary mb-1" data-toggle="counter-up">
                                                        <CountUp start={0} end={1234} duration={10} separator="," />
                                                    </h2>
                                                    <p className="fw-medium mb-0">Happy Clients</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-sm-6 wow animate__animated animate__fadeIn animate__delay-0-3" data-wow-delay="0.3s">
                                            <div className="d-flex align-items-center">
                                                <div className="d-flex flex-shrink-0 align-items-center justify-content-center bg-white" style={{ width: '60px', height: '60px' }}>
                                                    <i className="fa fa-check fa-2x text-primary"></i>
                                                </div>
                ...
                <div className="container-fluid bg-light overflow-hidden my-5 px-lg-0">
                    <div className="container feature px-lg-0">
                        <div className="row g-0 mx-lg-0">
                            <div className="col-lg-6 feature-text py-5 wow animate__animated animate__fadeInUp animate__delay-0-5" data-wow-delay="0.5s">
                ...
                <div className="container-fluid bg-light overflow-hidden my-5 px-lg-0">
                    <div className="container quote px-lg-0">
                        <div className="row g-0 mx-lg-0">
                            ...
                            <div className="col-lg-6 quote-text py-5 wow animate__animated animate__fadeIn animate__delay-0-5" data-wow-delay="0.5s">
                                <div className="p-lg-5 pe-lg-0">
                                    <div className="section-title text-start">
                ...
                <div className="container-xxl py-5">
                    <div className="container">
                        ...
                        <div className="row g-4">
                            <div className="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp animate__delay-0-1" data-wow-delay="0.1s">
                            ...
                            <div className="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp animate__delay-0-3" data-wow-delay="0.3s">
                                <div className="team-item">
                                    <div className="overflow-hidden position-relative">
                            ...
                            <div className="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp animate__delay-0-5" data-wow-delay="0.5s">
                                <div className="team-item">
                                    <div className="overflow-hidden position-relative">
                            ...
                            <div className="col-lg-3 col-md-6 wow animate__animated animate__fadeInUp animate__delay-0-7" data-wow-delay="0.7s">
                                <div className="team-item">
                                    <div className="overflow-hidden position-relative">
                ...
                {/* <!-- Testimonial Start --> */}
                <div className="container-xxl py-5 wow animate__animated animate__fadeInUp animate__delay-0-1" data-wow-delay="0.1s">
                    <div className="container">
                        <div className="section-title text-center">
                            <h1 className="display-5 mb-5">Testimonial</h1>
                        </div>
                        <OwlCarousel2 className="testimonial-carousel owl-loaded owl-drag"  {...optionsTestimonials} >
